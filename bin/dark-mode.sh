...
function enable() {
    ...
    gsettings set org.cinnamon.desktop.background picture-uri "file://${HOME}/Pictures/Wallpapers/dark-mode-wallpaper.jpg"
...
function disable() {
    ...
    gsettings set org.cinnamon.desktop.background picture-uri "file://${HOME}/Pictures/Wallpapers/light-mode-wallpaper.jpg"
